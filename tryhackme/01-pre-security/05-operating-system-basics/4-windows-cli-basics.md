...
- **PERINTAH NAVIGASI**: cd              → cek lokasi direktori saat ini (tanpa argumen)
...
- **Contoh kombinasi**: dir /s task_brief.txt  → cari file task_brief.txt di seluruh subfolder
