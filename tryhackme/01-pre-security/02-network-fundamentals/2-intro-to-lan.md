...
- **Fungsi Switch vs Hub**: Switch : Kirim data LANGSUNG ke tujuan (unicast)
...
- **Mengapa perlu**: → Jaringan besar (kantor, bisnis) butuh pemisahan- Contoh : Accounting, Finance, HR → subnet berbeda
...
- **Manfaat Subnetting**: Efficiency   = data tidak banjiri seluruh jaringan
...
- **Kepanjangan**: Dynamic       = Dinamis/berubah-ubah
- **Host**: Perangkat
- **Configuration**: Konfigurasi
- **Protocol**: Aturan/protokol

- **2 Cara Assign IP**: Manual  = diketik langsung ke perangkat (statis)
