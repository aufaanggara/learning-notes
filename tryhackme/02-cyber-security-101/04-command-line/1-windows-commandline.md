...
- **SWITCH NETSTAT**: -a  = tampilkan semua koneksi + port LISTENING
...
- **SWITCH DIR**: dir /a  = tampilkan file tersembunyi & system files
...
- **WILDCARD**: *             = semua file / karakter apapun
...
- **FILTER TASKLIST**: /FI "imagename eq nama.exe"  = filter berdasarkan nama program
