...
8 ELEMEN TASKBAR :
1. Desktop Icons        → Shortcut ke Recycle Bin, folder, app
                          (fully customizable)
...
6 ELEMEN FILE EXPLORER :
1. Folder target di Desktop
...
5 TAB TASK MANAGER :
1. Processes   → App & background process yang berjalan + resource usage
...
JENIS SCAN :
Quick scan  → Periksa folder umum tempat ancaman biasa bersembunyi
...
3 PROFIL JARINGAN :
Domain  → Terhubung ke jaringan domain organisasi/kantor
