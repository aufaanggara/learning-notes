...
- **Cara kerja**: Kamu ketik  → "google.com"
...
- **Alur HTTP Communication**: 1. CLIENT → kirim HTTP REQUEST (GET /index.html)
  2. Lewat INTERNET
