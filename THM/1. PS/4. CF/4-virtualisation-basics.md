...
- **Contoh penggunaan**: → Butuh Kali Linux tapi tidak mau beli laptop baru?
...
- **Aksi pada VM**: ▶ Play Button   → Start VM
  ⬛ Stop Button  → Stop VM
...
- **Status warna bar**: Hijau  → Normal, aman
...
- **Contoh analisis**: HV-PROD-01 : CPU 45%, Mem 68%, Storage 72% → AMAN, bisa tambah VM
