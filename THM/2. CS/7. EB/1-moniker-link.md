...
- **Versi Terdampak**: Office LTSC 2021    → dari 19.0.0
...
- **Contoh**: tryhackme::THM-MONIKERLINK:30aca553...:1A54BB46...:0101...

- **Cara tahu tipenya**: 1. Responder tulis eksplisit → [SMB] NTLMv2-SSP
...
- **Yang dicari rule ini**: $a1 → header "Subject: "      (wajib ada)
  $a2 → header "Received: "     (wajib ada)
  $xr1→ pola file:///\\ diikuti path + karakter ! + ekstensi file

- **Kondisi trigger**: filesize < 1000KB
