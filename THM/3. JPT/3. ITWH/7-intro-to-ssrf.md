...
- **Bypass**: → Buat subdomain yang namanya mengandung
...
- **Contoh rentan**: ?fetch-file.php?fname=file.pdf&srv=storage.cloud.thm&port=8001
  ↑ ada srv= (hostname) dan port= → sangat mencurigakan

- **Contoh TIDAK rentan**: ?categoryId=5325   → hanya angka ID (lebih ke IDOR)
